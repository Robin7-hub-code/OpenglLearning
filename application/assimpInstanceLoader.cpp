...
Object* AssimpInstanceLoader::load(const std::string& path,unsigned int InstanceCount) {
	//拿出模型所在目录
...
void AssimpInstanceLoader::processNode(aiNode* ainode, Object* parent, const aiScene* scene, const std::string& rootPath,unsigned int InstanceCount) {
...
InstanceMesh* AssimpInstanceLoader::processMesh(aiMesh* aimesh, const aiScene* scene, const std::string& rootPath,unsigned int InstanceCount) {
